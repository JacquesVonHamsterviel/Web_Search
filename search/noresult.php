...
<table width="95%" border=0 align="center">
  <tr> 
    ...
    <td width=139 valign="top" height="69"><a href="<?php echo $config["url"];?>"><img src="../include/images/logo.gif" border="0"></a></td>
        ...
        <tr> 
          <td class="padd10"><br>
            <span class="p2">造成搜索无结果的原因可能有多种，请查看下面提示的几种情况来调整您的查询词以获得您所要的信息。
              ...
              <br>例如：想查找宫崎骏的电影《千与千寻》，却错误地输入了“<a href="<?php echo $config["url"];?>/s?wd=%C7%A7%D3%EB%C7%AA%D1%B0+%B9%AC%C6%E9%BF%A1&cl=3" target="_blank">千与仟寻 宫崎俊</a>”，这样就无法达到目的。把查询词修改为正确的“<a href="<?php echo $config["url"];?>/s?ct=0&ie=utf-8&bs=%C7%A7%D3%EB%C7%AA%D1%B0+%B9%AC%C6%E9%BF%A1&sr=&z=&wd=%C7%A7%D3%EB%C7%A7%D1%B0+%B9%AC%C6%E9%BF%A5&cl=3&f=8" target="_blank">千与千寻 宫崎骏</a>”就可以准确地找到您所要的信息。 
			  <br>
			  此外，百度会对常见的错别字词出纠错提示。以上面的查询词为例，在页面上方就会有如下提示：<br>
              <strong>您要找的是不是 : <a href="<?php echo $config["url"];?>/s?wd=%C7%A7%D3%EB%C7%A7%D1%B0+%B9%AC%C6%E9%BF%A5&lm=0&si=&rn=10&ie=utf-8&ct=0&cl=3&f=12" target="_blank">千与千寻 宫崎骏 </a>&nbsp;</strong><br>
              <br>
			  <li>
			  <B>如果您输入的查询信息太多，可能导致无结果。您可以尝试简化输入的查询信息来获取更多的结果。</B></li>
              <br>例如：找北京市的海淀医院，有用户这样搜：“<a href="<?php echo $config["url"];?>/s?ie=utf-8&bs=%C7%A7%D3%EB%C7%A7%D1%B0+%B9%AC%C6%E9%BF%A5&sr=&z=&wd=%CE%D2%CF%EB%D5%D2%B1%B1%BE%A9%CA%D0%BA%A3%B5%ED%C7%F8%D6%D0%B9%D8%B4%E5%B8%BD%BD%FC%B5%C4%BA%A3%B5%ED%D2%BD%D4%BA&ct=0&cl=3&f=8" target="_blank">我想找北京市海淀区中关村附近的海淀医院</a>”，于是查询无结果。<br>
			  百度会严格按照您输入的字词进行检索。因此，您提交给百度的查询词，请尽量只包含最关键的信息。<br>
			  以上面的查询为例，可以简化成这样：
              <a href="<?php echo $config["url"];?>/s?ct=0&ie=utf-8&bs=%CE%D2%CF%EB%D5%D2%B1%B1%BE%A9%CA%D0%BA%A3%B5%ED%C7%F8%D6%D0%B9%D8%B4%E5%B8%BD%BD%FC%B5%C4%BA%A3%B5%ED%D2%BD%D4%BA&sr=&z=&wd=%B1%B1%BE%A9%CA%D0%BA%A3%B5%ED%D2%BD%D4%BA&cl=3&f=8" target="_blank">北京市海淀医院</a>              <br>
              由于“海淀医院”只在北京有，因此，单搜“<a href="<?php echo $config["url"];?>/s?ie=utf-8&bs=%B1%B1%BE%A9%CA%D0%BA%A3%B5%ED%D2%BD%D4%BA&sr=&z=&wd=%BA%A3%B5%ED%D2%BD%D4%BA&ct=0&cl=3&f=8" target="_blank">海淀医院</a>”，一样可以达到目的。
			<br><br>
