...
<table width="95%" border=0 align="center">
  <tr height=60>
    ...
    <td width=139 valign="top" height="69"><a href="<?php echo $config["url"];?>"><img src="<?php echo $config["url"];?>/include/images/logo.gif" border="0"></a></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="750"><br> <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                        ...
                        src="<?php echo $config["url"];?>/include/images/logo-80px.gif" alt=config border=0
                        align=bottom></A>
...
&lt;a href="<?php echo $config["url"];?>/"&gt;&lt;img src="<?php echo $config["url"];?>/include/images/logo-80px.gif" alt="config" align="bottom" border="0"&gt;&lt;/a&gt;
...
<table width="95%" border=0 align="center">
  <tr>
    <td align=center class=p1> <font color="#666666">&copy; 2009 <?php echo $config["name"];?></font></td>
  </tr>
</table>
</body></html>