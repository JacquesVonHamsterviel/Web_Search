...
<table width="95%" border=0 align="center">
  <tr height=60> 
    ...
    <td width=139 valign="top" height="69"><a href="<?php echo $config["url"];?>"><img src="../include/images/logo.gif" width="137" height="46" border="0"></a></td>
...
<table width="95%" border=0 align="center">
<TR>
    <TD class=p1 align=middle><FONT color=#666666>&copy; 2009 <?php echo $config["name"];?></FONT></TD>
</TR>
</table>
</body></html>