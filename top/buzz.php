...
<div class="wrap">
  <div class="l side-bar">
		...
		<div class="crumbs"><a href="index.php" target="_blank">Google风云榜</a>&nbsp;&nbsp;&gt;&nbsp; 热门搜索排行榜</div>
		<div class="content">
		...
		<div class="footer">
			&copy;2012&nbsp;Somao&nbsp;
			<a href="../" target="_blank">使用Google前必读</a>&nbsp;
			<a href="about_top.php" target="_blank">关于Google风云榜</a>
		</div> 
	</div>
