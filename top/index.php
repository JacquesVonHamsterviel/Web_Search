...
<div class="wrap">
  <div class="wrap search-home">
	    <div id="ba" class="clearfix">
            <div id="ba_lg">
                <a href="index.php"><img src="/include/images/log.gif" alt="搜索风云榜" width="110" height="40" border="0"></a>            </div>
            <div id="ba_sc">
                <p id="ba_nv">
	...
	<h1>七日关注</h1>
        <div class="box">
			...
			<table>
        	        ...
        	        <tr>
                        	<td><span class="title no8"><a target="_blank" href="../s/?wd=%B0%D9%B6%C8%CD%B3%BC%C6&s=">Google统计</a></span></td>
...
<div class="box-spe flash l">
	<h1>当月搜索</h1>
        <div class="box">
        	<div class="t_list">
                   <div class="bhot"><a href="#" target="_blank">Google沸点</a></div>
                   <div class="word-adv" style="overflow:hidden;">
	                	<div id="oneNew">
                        		<a href="#" target="_blank">Google搜索风云榜新版开通了！</a><br>
        ...
        <div class="group top_keyword" name="BLUEBA_OBJ_ID" id="BLUEBA_OBJ_ID">
            ...
            <div class="r wind-vane">
                ...
                <ul id="tabC1-cont-0" class="days">
        	      ...
        	      <li><span class="title no2"><a target="_blank" href="../s/?wd=%D4%C6%C6%F3%CB%D1%A3%AC%C6%B7%C5%C6%CB%D1%CB%F7%A3%AC%C9%FA%BB%EE%CB%D1%CB%F7%A3%AC%B7%FE%CE%F1%CB%D1%CB%F7%A3%AC&s=">Google，品牌搜索，生活搜索，服务搜索，</a></span></li>
        	      ...
        	      <li><span class="title no6"><a target="_blank" href="../s/?wd=%D4%C6%C6%F3%CB%D1%CB%D1%CB%F7%D2%FD%C7%E6&s=">Google搜索引擎</a></span></li>
  
        	      <li><span class="title no7"><a target="_blank" href="../s/?wd=ss&s=">ss</a></span></li>
  
        	      <li><span class="title no8"><a target="_blank" href="../s/?wd=%CB%D1%C3%A8%BC%AF%B3%C9%CB%D1%CB%F7&s=">Google集成搜索</a></span></li>
