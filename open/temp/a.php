...
<table width=910 border=0 align="center" cellpadding=0 cellspacing=0>
  <tr>
    <td width=175 rowspan=3><a href="<?php echo $config["url"]?>"><img src="<?php echo $config["url"]."/include/images/logo.gif";?>"></a></td>
...
<table width=910 align="center" cellpadding=0 cellspacing=1 bgcolor=D0E3F2 style="margin-bottom:8px;">
  <td bgcolor=E6F4FF class=b1><a href="<?php echo $config["url"];?>"><?php echo $config["name"];?>首页</a>&nbsp;&gt;&nbsp;<?php echo $title;?></td>
</table>
