...
function checkgbform()
{
    ...
    if(document.gbform.content.value!="")
   {
       ...
       if(document.gbform.entered_imagecode.value=="")
   {
       alert("为防止某些人恶意留言,本站已关闭留言反馈功能！");
       document.gbform.entered_imagecode.focus();
	   return false;
   }
...
<table width=910 border=0 align="center" cellpadding=0 cellspacing=0>
  <tr>
    ...
    <td width=793 height=37 align=right valign=bottom style="font-size:14px;font-weight:bold;"><span class="b1"><a href="#write"><font color=\"#3366CC\">给<?php echo $config["name"];?>留言</a></span></td>
  </tr>
  <tr>
    <td height=1 bgcolor=D0E3F2></td>
  </tr>
  <tr>
    <td height=13><img src="../include/images/log.gif" width="272" height="92" border="0"></td>
  </tr>
</table>
<br>
<table width=910 align="center" cellpadding=0 cellspacing=1 bgcolor=D0E3F2 style="margin-bottom:8px;">
  <td bgcolor=E6F4FF class=b1><a href="<?php echo $config["url"];?>"><font color=\"#3366CC\"><?php echo $config["name"];?>首页</a>&nbsp;&gt;&nbsp;<a href="./"><font color=\"#3366CC\">留言首页</a></td>
</table>
  ...
  <tr>
	...
	?>
      <tr>
        ...
        <td class="p14"><font color=#0000cc><a target="_blank" href="f/?kz=<?php echo $row["gid"];?>"><font color=\"#3366CC\"><?php echo $row["title"];?></a></font></td>
      </tr>
	  <tr>
	    <td>&nbsp;</td>
     ...
     <a href="f/?kz=<?php echo $row["gid"];?>" class=t><font color=\"#3366CC\">查看</a>&nbsp;<a href="f/?kz=<?php echo $row["gid"];?>#reply" class=t><font color=\"#3366CC\">回复</a>&nbsp;</div></td>
	  </tr>
      <tr>
        <td>&nbsp;</td>
