...
<td><table width="100%" height="65" align="center" cellpadding="0" cellspacing="0">
  <tr valign=middle>
    <td width="208" valign="top" style="padding-left:8px;width:137px;" nowrap><a href="../"><img src="../include/images/logo.gif" border="0" width="137" height="46" alt="到<?php echo $config["name"];?>首页"></a></td>
