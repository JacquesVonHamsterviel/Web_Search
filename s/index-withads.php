<?php
require "../global.php";
require "../include/cache/s_cate_array.php";
...
<OL id=list>
  <LI>
	...
	<DIV class="a_d">
      <div align="left">
       <H2 align="left" style="font-size:8px;"><a href="<?php echo "click.php?".base64_encode("url=".$link["url"]."&link_id=".$link["link_id"]);?>" target="_blank"><?php echo $link["title"];?></a><br>
            </H2>
       <DIV class=dig>
