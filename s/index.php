<?php
//require "../global.php"; require "../include/cache/s_cate_array.php";
require_once("../global.php");
require_once("../include/cache/s_cate_array.php");
require_once("global.func.php");
require_once("search.class.php");
$s=intval($_GET["s"]);
$wd=$_GET["wd"];
$from_host=str_replace("http://","",GetSiteUrl($_SERVER['HTTP_REFERER']));
if($from_host!=$_SERVER['HTTP_HOST']){$wd=get_encoding($wd,"utf-8");}
$old_wd=$wd;
$wd=FilterSearch($wd);
if(strlen($wd)<=0){echo "<script>alert('请输入搜索内容！！！')</script>";}
$wd_en=urlencode($wd);		
$is_site=false;					
class runtime
{
...
.i {
	BORDER-RIGHT: #b6b6b6 1px solid; PADDING-RIGHT: 7px; BORDER-TOP: #7b7b7b 1px solid; PADDING-LEFT: 7px; BACKGROUND: url(../include/images/i2.png) no-repeat; PADDING-BOTTOM: 3px; FONT: 16px arial; VERTICAL-ALIGN: top; BORDER-LEFT: #7b7b7b 1px solid; WIDTH: 519px; MARGIN-RIGHT: 5px; PADDING-TOP: 7px; BORDER-BOTTOM: #b6b6b6 1px solid; HEIGHT: 32px}
.btn {
	BORDER-TOP-WIDTH: 0px; PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BORDER-LEFT-WIDTH: 0px; BACKGROUND: url(../include/images/i2.png) #ddd 0px -35px; BORDER-BOTTOM-WIDTH: 0px; PADDING-BOTTOM: 0px; WIDTH: 95px; CURSOR: pointer; PADDING-TOP: 2px; HEIGHT: 32px; BORDER-RIGHT-WIDTH: 0px
...
.btn_wr {
	DISPLAY: inline-block; BACKGROUND: url(../include/images/i2.png) no-repeat -202px bottom; WIDTH: 97px; POSITION: relative; HEIGHT: 34px; _padding-top: 1px
}
#sc {
...
#mCon {
	PADDING-RIGHT: 18px; PADDING-LEFT: 0px; RIGHT: 7px; BACKGROUND: url(../include/images/arr.gif) no-repeat right center; PADDING-BOTTOM: 0px; CURSOR: pointer; LINE-HEIGHT: normal; PADDING-TOP: 0px; POSITION: absolute; TOP: 6px
}
#mCon SPAN {
...
<tr valign=middle>
<td width="100"><a href="../"><img src="../include/images/logo.gif" border="0" width="128" height="54" alt="到<?php echo $config["name"];?>首页"></a></td>
<td width="1300" valign="middle"><table cellspacing="0" cellpadding="0"> 
    <tr>
    <td width="794" nowrap><p class="f14 f14 f14 f14 f14">　
	<span class="STYLE13">网页</span>　
	 <a href="../image/" class="STYLE15">图片</a>　 
	 <a href="../video/" class="STYLE15">视频</a>　 
	 <a href="../map/" class="STYLE15">地图</a></p>
      <DIV id=sc>
<div class="searchbox">
 <form action="" method="get">
   <p align="center">
     <input align="middle" name="wd" class="wd" id="kw" value="<?php echo $wd;?>" onfocus="javascript:if(this.value=='请输入关键字搜索'){this.value='';this.style.color='#333'}" onblur="javascript:if(this.value==''){this.value='请输入关键字搜索';this.style.color='#CCC'}" maxlength="1000" size="50" autocomplete="off" baidusug="1" x-webkit-speech="" >
...
if($total>0)
{
  ...
  {     
?>
<table width="300" border="0" cellpadding="0" cellspacing="0" id="1">
  <tr><td width="300" class=f>
            <p>
              <?php
			if($link["is_tg"]>0)
			{
...
<OL id=list>
  <LI>
	...
	<DIV class="a_d">
      <div align="left">
       <H2 align="left" style="font-size:25px;"><a href="<?php echo "click.php?".base64_encode("url=".$link["url"]."&link_id=".$link["link_id"]);?>" target="_blank"><?php echo $link["title"];?></a><br>
            </H2>
       <DIV class=dig>
...
else
{
 ...
 ?>
  ...
  <P align="left" style="font-size:25px;"><CITE class=s2><?php echo $link["url"];?> - <?php
...
<div class="searchbox-end">
 <form action="" method="get">
   <p align="left">
     <input align="middle" name="wd" class="wd" id="kw" value="<?php echo $wd;?>" onfocus="javascript:if(this.value=='请输入关键字搜索'){this.value='';this.style.color='#225'}" onblur="javascript:if(this.value==''){this.value='请输入关键字搜索';this.style.color='#CCC'}" maxlength="1000" size="50" autocomplete="off" baidusug="1" x-webkit-speech="">
     <input name="re" type="hidden" value="1">
     <input id="btn" class="btn" align="middle" value="搜索" type="submit">
   </p>
  </form>
