        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD 
                style="PADDING-RIGHT: 20px; BACKGROUND: url(images/idmax_bg4.gif) no-repeat right 50%" 
                width=341 height=300><a href="../"><IMG 
                  src="../include/images/log.gif" alt=搜索引擎 width="110" height="40" border="0"></a><a href="../"><img src="images/logo.gif" alt="Google搜索引擎" width="138" height="41" border="0" longdesc="../"></a><BR>
登录账号：admin 密码：admin</TD>
                <TD width=357>
                  <TABLE 
...
border=0>
  ...
  <TR>
    <TD align=middle height=33>
      <HR color=#cce4ee>
      <FONT 
      style="FONT-SIZE: 10px; FONT-FAMILY: Arial, Helvetica, sans-serif"><STRONG><script language=javascript> 
