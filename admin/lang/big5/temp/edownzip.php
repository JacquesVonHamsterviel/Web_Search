...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
  ...
  <tr> 
    <td height="30" bgcolor="#FFFFFF"> 
      <div align="center">[<a href="';echo $file;echo '">下載壓縮包</a>]</div></td>
  </tr>
  <tr> 
    <td height="30" bgcolor="#FFFFFF"> 
      <div align="center">[<a href="phome.php?f=';echo $f;echo '&phome=DelZip" onclick="return confirm(\'確認要刪除？\');">刪除壓縮包</a>]</div></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">
