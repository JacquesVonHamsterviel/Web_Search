...
<form name="ebakredata" method="post" action="phomebak.php" onsubmit="return confirm(\'確認要恢復？\');">
  <table width="70%" border="0" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="25"> 
        ';echo $bakpath;echo '        / 
        <input name="mypath" type="text" id="mypath" value="';echo $mypath;echo '"> <input type="button" name="Submit2" value="選擇目錄" onclick="javascript:window.open(\'ChangePath.php?change=1\',\'\',\'width=750,height=500,scrollbars=yes\');"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
