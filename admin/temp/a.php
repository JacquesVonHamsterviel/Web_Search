...
<table width=910 border=0 align="center" cellpadding=0 cellspacing=0>
  <tr>
    <td width=117 rowspan=3><a href="';echo $config['url'];echo '"><img src="';echo $config['url'].'/include/images/log.gif';;echo '" width="117" height="50"></a></td>
...
<table width=910 align="center" cellpadding=0 cellspacing=1 bgcolor=D0E3F2 style="margin-bottom:8px;">
  <td bgcolor=E6F4FF class=b1><a href="';echo $config['url'];;echo '">';echo $config['name'];;echo '??</a>&nbsp;&gt;&nbsp;';echo $title;;echo '</td>
</table>
