...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tablebg">
  <tr>
    ...
    <td><input type="text" name="title" value="';echo $title;;echo '"/></td>
  </tr>
  <tr>
    <td>关键词:</td>
    <td><input type="text" name="keywords" value="';echo $keywords;;echo '"/></td>
  </tr>
  <tr>
    <td>网址:</td>
    <td><input type="text" name="url" value="';echo $url;;echo '"/></td>
  </tr>
...
$sql='select * from ve123_links'.$where;
...
;echo '  <tr>
    ...
    <td title="';echo $row['title'];;echo '">';echo str_cut($row['title'],40);;echo '</td>
    <td title="';echo $row['url'];;echo '"><a target="_blank" href="';echo $row['url'];;echo '">';echo str_cut($row['url'],10);;echo '</a>&nbsp;&nbsp;&nbsp;(<a target="_blank" href="';echo $site['url'].'/s/?wd=site:'.str_replace('http://','',GetSiteUrl($row['url'])).'';;echo '">site一下</a>)</td>
    <td>';echo date('Y-m-d H:i:s',$row['updatetime']);;echo '</td>
    <td>';echo $row['level'];;echo '</td>
    <td>
	<a href="?action=add_all_links&url=';echo GetSiteUrl($row['url']);;echo '">收录全站</a>&nbsp;
	<a href="?action=update&url=';echo $row['url'];;echo '">更新</a>&nbsp;
	<a href="?action=modify&link_id=';echo $row['link_id'].'&url='.$row['url'].'';;echo '">修改</a>&nbsp;
	<a href="?action=del&link_id=';echo $row['link_id'];;echo '" onClick="if(!confirm(\'确定删除吗?\')) return false;">删除</a></td>
