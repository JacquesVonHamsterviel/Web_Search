...
E_D("replace into `ve123_dh_goodlinks` values('1','菏泽亿时达本地搜索','http://wwwadminchn.comm/','0');");
...
E_D("replace into `ve123_dh_goodlinks` values('35','<font color=red>菏泽搜索</font>','http://www.adminchn.com/','0');");
