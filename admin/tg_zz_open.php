...
break;
case 'del':
$db->query("delete from ve123_zz_tg_open where link_id='".intval($_GET['link_id'])."'");
break;
}
;echo '<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tablebg">
  ...
  ';
$result=$db->query('select * from ve123_zz_tg_open');
...
$sql="select * from ve123_zz_tg_open where link_id='$link_id'";
$rs=$db->get_one($sql);
