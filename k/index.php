...
<tr><td>
  <div style="text-align:left;background-color:#ffffff;color:#000000">
    <div style="margin:6px 18px 0 10px;float:left"><a href="<?php echo $config["url"];?>"><img style="border:0px" alt="到<?php echo $config["name"];?>首页" src="http://134.175.107.91:81/include/images/logo.gif"></a></div>
